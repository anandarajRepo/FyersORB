...
def show_strategy_help():
    ...
    print("\n STRATEGY OVERVIEW:")
    print("• Identifies opening range during first 5 minutes of trading (9:15-9:30 AM)")
...
def show_market_status():
    ...
    try:
        ...
        phase_descriptions = {
            ...
            'SIGNAL_GENERATION': ' Signal Generation Window (9:30-3:00 PM)',
        ...
        print(f"  Signal Generation: 09:30 - 15:00 (Breakout Detection)")
